(function($){
  ...
  function initialize_field( $el ) {
    ...
    if ($hiddenField.data('algolia-type')) {
      options.type = $hiddenField.data('algolia-type');
    }

    if ($hiddenField.data('algolia-countries')) {
      options.countries = $hiddenField.data('algolia-countries').split(',');
    }
